...
<br>
Desarrollar una web funcional y atractiva con una interfaz moderna y adaptable (responsive design)
...
Aplicar metodología Agile (Scrum) para la gestión del desarrollo.
